...
class DVLPublisher : public rclcpp::Node
{
  public:
    ...
    {
      publisher_ = this->create_publisher<brov2_interfaces::msg::DVLBeam>("dvl_data", 10);
      timer_ = this->create_wall_timer(
      500ms, std::bind(&DVLPublisher::timer_callback, this));
    }
  ...
  private:
    void timer_callback()
    {
      brov2_interfaces::msg::DVLBeam message = brov2_interfaces::msg::DVLBeam();
      message.id = 69;
      RCLCPP_INFO(this->get_logger(), "Publishing data");
      publisher_->publish(message);
    }
    rclcpp::TimerBase::SharedPtr timer_;
    rclcpp::Publisher<brov2_interfaces::msg::DVLBeam>::SharedPtr publisher_;
    size_t count_;
};
