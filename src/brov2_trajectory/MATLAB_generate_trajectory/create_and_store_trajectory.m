function path_constraints  = create_and_store_trajectory(trajectory_file_name,           ...
    ...
    axis([min(trajectory_constraints(:,2))-2*turn_radius,max(trajectory_constraints(:,2))+2*turn_radius,...
          min(trajectory_constraints(:,3))-2*turn_radius,max(trajectory_constraints(:,3))+2*turn_radius,...
          min(trajectory_constraints(:,4)),max(trajectory_constraints(:,4))]);
